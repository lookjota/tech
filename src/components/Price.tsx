            ...
            <div
                ...
                <ul className="flex-1 p-0 mt-4 ml-5 leading-7 text-gray-900 border-0 border-gray-200">
                    <li className="inline-flex items-center block w-full mb-2 ml-5 font-semibold text-left border-solid">
                        <svg className="w-5 h-5 mr-2 font-semibold leading-7 text-violet-600 sm:h-5 sm:w-5 md:h-6 md:w-6"
                ...
                <a href="#"
                    className="inline-flex justify-center w-full px-4 py-3 mt-8 font-sans text-sm leading-none text-center text-violet-600 no-underline bg-transparent border border-violet-600 rounded-md cursor-pointer hover:bg-violet-700 hover:border-violet-700 hover:text-white focus-within:bg-violet-700 focus-within:border-violet-700 focus-within:text-white sm:text-base md:text-lg">
                    Start Now
                </a>
            </div>
            {/* <!-- Price 2 --> */}
            <div
                className="relative z-20 flex flex-col items-center max-w-md p-4 mx-auto my-0 bg-white border-4 border-violet-600 border-solid rounded-lg sm:p-6 md:px-8 md:py-16">
                <h3
                    className="m-0 text-2xl font-semibold leading-tight tracking-tight text-black border-0 border-gray-200 sm:text-3xl md:text-4xl">
                    Basic
                </h3>
                ...
                <a href="#"
                    className="inline-flex justify-center w-full px-4 py-3 mt-8 font-sans text-sm leading-none text-center text-white no-underline bg-violet-600 border rounded-md cursor-pointer hover:bg-violet-700 hover:border-violet-700 hover:text-white focus-within:bg-violet-700 focus-within:border-violet-700 focus-within:text-white sm:text-base md:text-lg">
                    Start Now
                </a>
            </div>
            {/* <!-- Price 3 --> */}
